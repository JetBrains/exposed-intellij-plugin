    ...
    init {
        ...
        fun initializeString() {
            ...
            when {
                ...
                // TODO uncomment once it's clear why this fails when launched from Gradle plugin
                name.contains("time") ->
                    initializeColumnParameters(LocalDateTime::class, null)
                name.contains("date") ->
                    initializeColumnParameters(LocalDate::class, null)
